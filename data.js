// --- START OF FILE data.js (Part 1 of 3) ---
// js/data.js - Core Game Data (Concepts, Elements, Prompts, etc.) (v4.5 - XP/Leveling v1.0 - Part 1)

console.log("data.js loading... Part 1: Core Definitions & Concepts 1-40 with MicroStories (v4.5 + XP/Leveling v1.0)");

// --- Element Definitions (7 Elements) ---
...
// --- Concepts Data (Combined Parts 1 & 2 with Placeholders Filled) ---
const concepts = [
    // --- Concepts 1-40 (From Part 1) ---
    {
    ...
    // --- Concepts 41-139 (From Part 2 - Now Filled) ---
    {
