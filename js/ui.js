...
// const markAsFocusButton = document.getElementById('markAsFocusButton'); // REMOVED global reference
...
export function showScreen(screenId) {
    ...
    navButtons.forEach(button => {
        if (button) {
             ...
             // Remove hidden-by-flow if post-questionnaire
    ...
    if (isPostQuestionnaire) {
        // Ensure other elements are visible now that phase is removed
...
export function displayEvolutionSection(conceptData, discoveredData) {
    ...
    const showSection = isDiscovered && canUnlockArt && !alreadyUnlocked; // Condition simplified
...
// --- Focus Button Status (No phase check) ---
...
// --- Sell Button Status (No phase check) ---
export function updatePopupSellButton(conceptId, conceptData, inGrimoire, inResearchNotes) {
    ...
    if (context !== 'none' /* && phaseAllowsSell REMOVED */) {
        ...
        // Get markAsFocusButton locally within this function's scope if needed for positioning
