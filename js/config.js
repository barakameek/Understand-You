...
export const INITIAL_FREE_RESEARCH_COUNT = 3; // NEW: Number of free researches after questionnaire
...
// --- Onboarding Phases ---
// Define the progression stages and feature unlocks.
export const ONBOARDING_PHASE = {
    START: 0,                // Initial state, Welcome Screen
    QUESTIONNAIRE: 0.5,      // Added intermediate state (optional, useful for checks) - Currently doing Questionnaire
    PERSONA_GRIMOIRE: 1,     // Questionnaire done, Study (Discovery Mode), Grimoire basics, Persona Summary/Detailed toggle
    STUDY_INSIGHT: 2,        // First Concept added -> Standard Study Screen, Sell unlocked
    REFLECTION_RITUALS: 3,   // First Concept focused -> Reflection prompts trigger, Rituals visible
    ADVANCED: 4              // First Repo item/Evolve/Library -> Repository Screen, Evolution, Library unlocks
};
